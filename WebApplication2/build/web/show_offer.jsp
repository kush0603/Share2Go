...
try{
    ...
    String check = "SELECT source,destination,car_id,seat,offer_id,date FROM carpooling where user_id=? and seat>=1  order by date";
        ...
        while (rs.next()) {
            ...
            String check1 = "SELECT request_id,carpooling_takeride.user_id as uid,full_name,phone,source,destination,date,end_date FROM carpooling_takeride,user where carpooling_takeride.user_offering=? and carpooling_takeride.user_id=user.userid and status = 'pending' and carpooling_takeride.offer_id=?";
            ...
            while (rs1.next()) {
                //out.println(rs1.getObject("full_name"));
                ...
                json_inner.put("date", rs1.getDate("date"));
                json_inner.put("end_date", rs1.getObject("end_date"));
